    ...
    public partial class FormApplication : Form
    {
        ...
        private void buttonOpenDocument_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                docNumberScelto = Int32.Parse(textBoxOpenDocument.Text);
                var arxFile = _manager. ... . ...(docNumberScelto);

                //2) Prendo il file, lo porto in un path temporaneo e lo apro all'utente
        ...
        private void buttonEditFile_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //1) Chiedere all'utente quale docNumber modificare
                docNumberScelto = Int32.Parse(textBoxEditDocument.Text);

                //2) Individuiamo il documento da sostituire al profilo indicato
                var filePath = @"C:\Temp\immagineArxivar.png";

                //3) Effettuo il cambio del documento, aumentando la revisione
                ArxGenericException age;
                var esito = _manager. ... . ...(
                    out age,
                    new Arx_File(filePath),
                    System.Convert.ToInt32(docNumberScelto),
                    string.Empty);

                //4) Verifico l'esito delle operazioni
                if (esito)
        ...
        private void buttonOverwriteFile_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //1) Chiedere all'utente quale docNumber modificare
                docNumberScelto = Int32.Parse(textBoxOverWrite.Text);

                //2) Individuiamo il documento da sostituire al profilo indicato
                var filePath = @"C:\temp\documento.pdf";
