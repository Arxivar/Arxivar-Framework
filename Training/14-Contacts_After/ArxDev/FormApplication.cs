...
namespace ArxDev
{
    public partial class FormApplication : Form
    {
        ...
        private void buttonCategories_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //Carichiamo le tipologie di rubrica
                dgContacts.DataSource = _manager. ... . ...("RUBRICA");
            }
            catch (Exception exception)
            {
                MessageBox.Show(exception.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void buttonAddContact_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                insert.MAIL = Interaction.InputBox("Email principale della società", "Rubrica con WCF", "info@newelementspa.net");
        ...
        private void buttonEditContact_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //1) Mi recupero la rubrica da modificare e modifico il campo "cellulare"
                var update = _manager. ... . ...(System.Convert.ToInt32(textBoxEditContact.Text));
                update.CELL = "327 11 22 333";

                //2) Mi recupero il contatto del BackOffice e aggiorno il campo "reparto"
                var contattoDaAggiornare = update.Contatti.FirstOrDefault(x => String.Equals(x.CONTATTO, "BackOffice", StringComparison.CurrentCultureIgnoreCase));
                contattoDaAggiornare.REPARTO = "Ufficio direzionale";

                //3) Effettuo l'aggiornamento della rubrica con il suo contatto
                _manager. ... . ...(update);
